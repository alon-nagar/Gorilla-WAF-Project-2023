...
sqli_detection_model = pickle.load(open("attacks/sql_injection/ml_sqli_model.pickle", "rb"))
vectorizer = pickle.load(open("attacks/sql_injection/vectorizer_ml_sqli_model.pickle", "rb"))
